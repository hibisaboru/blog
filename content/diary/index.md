...
<!-- 本文 -->
#### 2026/06/10：
　珈琲を淹れて出勤。多少振り回されつつ、16時で社用のため退勤。自社の会議に出て、そのまま飲み会。21時頃に解散。AIを有効活用しているか、といった話題が出たが、現場では利用が制限されており、プライベートのほうがよほど使っている。今後はAIを使う前提のプログラム開発になるだろう、という話は聞き飽きた。そうなるのは分かるが、自分のいる現場の速度とは噛み合っていない。それが出遅れているのか、それとも平均値なのかは、飲み会の席ではいまいちよくわからなかった。まだ
#### 2026/06/09：
