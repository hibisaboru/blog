...
<!-- 本文 -->
#### 2026/06/14：
　珈琲を飲み、買い物に出て、iPad Proを発送したくらいで、あとはぼんやり、最近買ったレコードを聴きなおした。  
　アイコンにもう少し手を入れたついでに、ベクター変換について調べていた。画像を数式情報に置き換えることで、拡大しても画質が劣化しない形式である。.svg形式が知られているが、デザインの世界ではIllustratorで.ai形式にするのが一般的らしい。デザインの仕事をするでもないのに、Illustratorのサブスクを買うのは高すぎる。AIに聞いてみたところ、Affinityというソフトを紹介された。Canva傘下の編集ソフトらしい。早速読み込ませてみると、簡単に.svg形式で出力できた。便利。  
　SNSアイコンも出力しなおして、微調整する。気になっていた描画の粗もマイルドになった。ベクターデータができた勢いで、ステッカーとアクリルキーホルダーを発注してみる。韓国発送で2000円。飲みに行ったと思えば安いか。ただ、入稿は結局.pngで行って、ベクターデータは使わなかった。
#### 2026/06/13：
