...
<!-- 本文 -->
#### 2026/06/14：
　珈琲を飲み、買い物に出て、iPad Proを発送したくらいで、あとはぼんやり、最近買ったレコードを聴きなおしたりしていた。どこかへ遊びに行こうかとも思ったが、そそられるパーティー情報はなく、そのうえ酒を飲みたくない。かといって、ほかの選択肢がレコ屋DIGというのも白ける。結局、パソコンに向かう。  
　先週作成したSNSアイコンの細部が気になって、少しだけ手を入れた。そのついでに、ベクター変換について調べた。画像を数式情報に置き換えることで、拡大しても画質が劣化しない形式である。シャツなどのノベルティをつくるときに、できたら作成しておきたい形式。.svg形式が知られているが、デザインの世界ではIllustratorで.ai形式で入稿するのが一般的らしい。しかし、デザインの仕事をするでもないのに、Illustratorのサブスクを買うのは高すぎる。ChatGPTに聞いてみたところ、Affinityというソフトを紹介された。Canva傘下の編集ソフトらしい。早速、画像を読み込ませてみると、簡単に.svg形式で出力できた。便利。  
...
#### 2026/06/13：
　前日にメルカリに出したiPad Proの売却に成功する。だいぶ優秀な値段で売れたので、そのままiPad miniを購入しに行くことにした。家を出たついでに、紹介されたきり行ったことのなかった中津のMYRecordに立ち寄る。T-Connectionの78年作がおいしい値段で転がっており、つい散財。へたなレコ屋よりも品揃えがよく、値付けも悪くない。行きつけになるかもしれない。  
