...
<!-- 本文 -->
#### 2026/06/14：
　珈琲を飲み、買い物に出て、iPad Proを発送したくらいで、あとはぼんやり、最近買ったレコードを聴きなおしたりしていた。どこかに遊びに行こうかとも思ったが、なんとなく酒を飲みたくない。かといって、ほかの選択肢がレコ屋DIGというのもちょっと白けてきた。結局、パソコンに向かっている。  
　先週作成したSNSアイコンの細部が気になって、少しだけ手を入れた。そのついでに、ベクター変換について調べた。画像を数式情報に置き換えることで、拡大しても画質が劣化しない形式である。.svg形式が知られているが、デザインの世界ではIllustratorで.ai形式にするのが一般的らしい。デザインの仕事をするでもないのに、Illustratorのサブスクを買うのは高すぎる。ChatGPTに聞いてみたところ、Affinityというソフトを紹介された。Canva傘下の編集ソフトらしい。早速読み込ませてみると、簡単に.svg形式で出力できた。便利。  
　SNSアイコンも出力しなおして、微調整する。気になっていた描画の粗もマイルドになった。ベクターデータができた勢いで、ステッカーとアクリルキーホルダーを発注してみる。韓国発送で2000円。飲みに行ったと思えば安いか。ただ、入稿は結局.pngで行ったので、せっかく作ったベクターデータは使わなかった。
#### 2026/06/13：
