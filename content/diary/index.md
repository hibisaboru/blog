...
　自宅のPCまわりのセッティングをもう一段改善したく、調べていた。モニタスタンドを置いて目線を上げることと、スピーカーがほしい。数か月前に目星をつけていたKANTO AudioのUKIというモデルは、いつの間にかAmazonで買えなくなっている。メルカリに出品されているそれに悩みながら、デスクを考える。モニタスタンドも既製品には好みのものがないので、手元にあるアカシア集成材を使って何かできないかと考える。数年前に棚板として買ったが、結局使わなくなって無用の長物になっているものだ。色々見ていると脚だけ売っているようで、しかも最近は、3Dプリンタを使ってデザインしたものを自前で売っている人もいる。そのデザインがまたいい。脚だけ購入した。届くのが楽しみである。
#### 2026/06/14：
