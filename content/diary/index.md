...
<!-- 本文 -->
#### 2026/06/09：
　このところ、毎日のように積立NISAのことを気にして仕方ないので、成長投資枠の年額240万円を一括ですべて埋めることにした。手元の口座からそれぞれ資金を移した。これで、投資については当面できることがない。月の積立額をさらに上げれば年額上限に近づけられるが、生活防衛資金と少ない手取りを考えると、月5万円くらいが限界。しかし、最初は高掴みも怖いからと原資を数か月で分割投入する想定でいたが、始めてみると日々変動する資産額を気にしてしまうので、初めから一括投入でよかった気がした。こうしてNISA貧乏になるのか、と妙に納得。  
　在宅勤務はソツなく始まって、ソツなく終わった。物干しの陰にたまったホコリなどを掃除したら、だいぶすっきりした。本当はすべてのアイテムが簡単に移動できて、全面を床掃除できるような配置にしたい。退勤してベッドに横になったら、次の瞬間には日付を跨いでいた。
#### 2026/06/08：
